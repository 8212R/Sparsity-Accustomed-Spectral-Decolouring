...
plt.imshow(np.float32(SASD_t0_plotdata),interpolation = 'nearest', vmin = np.mean(a)-4.5, vmax = np.mean(a)+4.5, origin = 'lower')
clb = plt.colorbar()
...
plt.imshow(np.float32(LSD_t0_plotdata),interpolation = 'nearest', vmin = np.mean(b)-4.5, vmax = np.mean(b)+4.5, origin = 'lower')
clb = plt.colorbar()
clb.ax.set_title('sO$_2$ [%]')
circle = plt.Circle((16,16),8.0, fill = False, edgecolor= 'r', linewidth=8.0)
...
plt.imshow(np.float32(LU_t0_plotdata),interpolation = 'nearest', vmin = np.mean(c)-4.5, vmax = np.mean(c)+4.5, origin = 'lower')
clb = plt.colorbar()
clb.ax.set_title('sO$_2$[%]')
circle = plt.Circle((16,16),8.0, fill = False, edgecolor= 'r', linewidth=8.0)
