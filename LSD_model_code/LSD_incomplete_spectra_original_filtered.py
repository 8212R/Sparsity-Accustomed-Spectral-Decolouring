...
predictions = torch.reshape(predictions,[14909])

test_oxygenations = torch.reshape(test_oxygenations,[14909])
print(predictions)
...
a = create_violin_scatter_plot('lsd_skin_10.png', reshaped_predictions,reshaped_gts)
